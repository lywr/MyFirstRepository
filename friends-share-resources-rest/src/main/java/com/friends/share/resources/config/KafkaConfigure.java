//package com.zhidao.oper.car.butler.config;
//
...
//        //键的反序列化方式
//        properties.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, consumerKeyDeserializer1);
//        //值的反序列化方式
//        properties.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, consumerValueDeserializer1);
...
//        //键的反序列化方式
//        properties.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, producerKeyDeserializer1);
//        //值的反序列化方式
//        properties.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, producerValueDeserializer1);
...
//        //键的反序列化方式
//        properties.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, consumerKeyDeserializer2);
//        //值的反序列化方式
//        properties.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, consumerValueDeserializer2);
//        //自动提交的时间间隔 在spring boot 2.X 版本中这里采用的是值的类型为Duration 需要符合特定的格式，如1S,1M,2H,5D
...
//        //键的反序列化方式
//        properties.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, producerKeyDeserializer2);
//        //值的反序列化方式
//        properties.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, producerValueDeserializer2);
//        //acks=0 ： 生产者在成功写入消息之前不会等待任何来自服务器的响应。
//        //acks=1 ： 只要集群的首领节点收到消息，生产者就会收到一个来自服务器成功响应。
//        //acks=all ：只有当所有参与复制的节点全部收到消息时，生产者才会收到一个来自服务器的成功响应。
